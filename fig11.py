...
plt.text(1, 0.95, r"$(-\frac{d^2}{dy^2}-\frac{\epsilon}{2^{1/3}}+y)\phi_1(y)+2^{2/3}\phi_2(y)=0$", fontsize=16)
plt.text(1, 0.75, r"$(-\frac{d^2}{dy^2}-\frac{\epsilon}{2^{1/3}}-y)\phi_2(y)+2^{2/3}\phi_1(y)=0$", fontsize=16)
# plt.title(r"Iwo Bialynicki-Birula FIG.11 $\epsilon=5$ $\phi_1=0$, $\phi_1'=-0.36012$, $\phi_2=1$, $\phi_2'=0$ ", fontproperties="SimHei", fontsize=20)
plt.xlabel("y")

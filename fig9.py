...
"""
Figure 9 is from the numerical study in "Time crystals made of electron-positron pairs".
"""
import numpy as np
import sympy as sym
...
y0=[1,0, 0, -0.354651985]
t_left=np.arange(0,-2,-0.001)
...
# plt.title(r"Iwo Bialynicki-Birula FIG.10 $\epsilon=2$ $\phi_1=1$, $\phi_1'=0$, $\phi_2=0$, $\phi_2'=-0.354651985$ ", fontproperties="SimHei", fontsize=20)
plt.xlabel("y")
